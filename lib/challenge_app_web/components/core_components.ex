defmodule ChallengeAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ChallengeAppWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ChallengeAppWeb.Gettext, "errors", msg, opts)
    # end
